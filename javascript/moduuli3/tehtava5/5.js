...
for (const arrElements of picArray) {
  const title = document.createTextNode(arrElements.title);
  const caption = document.createTextNode(arrElements.caption);
  const description = document.createTextNode(arrElements.description);
  ...
  img.src = `${arrElements.image.medium}`;
  img.alt = `${arrElements.title}`;
